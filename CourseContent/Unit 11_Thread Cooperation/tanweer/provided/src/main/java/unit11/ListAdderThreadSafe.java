...
public class ListAdderThreadSafe implements Runnable {
    /**
     ...
     */
    public ListAdderThreadSafe(List<Integer> list) {
        this.list = list;
    }
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < numberOfThreads; i++) {
            ListAdderThreadSafe adder = new ListAdderThreadSafe(list);
