...
public class PackageMain {
    ...
    public static void main(String[] args) {
        ...
        //Part 2 - Packages in priority, length (increasing) order
         Collections.sort(packages, new PackageComparatorforlenght); // <== Update or Modify this line to sort as per requirement.

        System.out.println("Priority, Length order: " + packages);
        System.out.println();

        //Part 3 - Packages in priority, weight (decreasing) order
        Collections.sort(packages, new PackageComparatorforweight);   // <== Update or Modify this line to sort as per requirement.
