...
public class Program {
    ...
    public void partA(List<Student> students) {
        ...
        students.stream().filter(x -> x.getGrade() > 85).forEach(x -> System.out.println(x.getName() + " - " + x.getGrade()));;
    ...
    public void partB(List<Student> students) {
        ...
        students.stream().filter(x -> x.getAge() >= 18).forEach(x -> System.out.println(x.getName() + " - " + x.getAge()));;
