...
public class PackageMain {
    ...
    public static void main(String[] args) {
        ...
        Collections.sort(packages, new Part2Comparator()); // <== Update or Modify this line to sort as per requirement.

        System.out.println("Priority, Length order: " + packages);
        System.out.println();

        //Part 3 - Packages in priority, weight (decreasing) order
        Collections.sort(packages, new Part3Comparator());   // <== Update or Modify this line to sort as per requirement.
